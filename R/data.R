...
#' @format ## 'power_studies_cont_results'
...
#' @format ## 'power_studies_cont_est_results'
#' A list of matrices with powers
"power_studies_cont_est_results"
...
#' @format ## 'power_studies_disc_results'
#' A list of matrices with powers
"power_studies_disc_results"
...
#' @format ## 'power_studies_disc_est_results'
#' A list of matrices with powers
"power_studies_disc_est_results"
...
#' @format ## 'power_studies_cont_D5_results'
#' A list of matrices with powers
"power_studies_cont_D5_results"
